/**
 * Simple inline SVG icons used across the app.
 * Each icon accepts className and size (default 24px).
 */
...
export function TransactionIcon({ className, size = 24 }: IconProps) {
  return (
    <svg
      width={size}
      height={size}
